...
**Project**: playthrough-palette 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create an app that fetches a list of board game playthroughs for a boardgame or a list of boardgames 
...
```sh
git clone https://github.com/GPT-Engineer-App/playthrough-palette.git
cd playthrough-palette
npm i
